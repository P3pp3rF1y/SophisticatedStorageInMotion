...
public class ModEntities {
	...
	public static final RegistryObject<EntityType<StorageMinecart>> STORAGE_MINECART = ENTITY_TYPES.register("storage_minecart",
			() -> EntityType.Builder.of((EntityType.EntityFactory<StorageMinecart>) StorageMinecart::new, MobCategory.MISC).sized(0.98F, 0.7F)
					.clientTrackingRange(8).build(SophisticatedStorageInMotion.MOD_ID + ":storage_minecart"));
	public static final RegistryObject<EntityType<StorageBoat>> STORAGE_BOAT = ENTITY_TYPES.register("storage_boat",
			() -> EntityType.Builder.of((EntityType.EntityFactory<StorageBoat>) StorageBoat::new, MobCategory.MISC).sized(1.375F, 0.5625F)
	...
	public static final RegistryObject<MenuType<MovingStorageSettingsContainerMenu>> MOVING_STORAGE_SETTINGS_CONTAINER_TYPE = MENU_TYPES
			.register("moving_storage_settings", () -> IForgeMenuType.create(MovingStorageSettingsContainerMenu::fromBuffer));

	public static final RegistryObject<MenuType<MovingLimitedBarrelContainerMenu<?>>> MOVING_LIMITED_BARREL_CONTAINER_TYPE = MENU_TYPES
			.register("moving_limited_barrel", () -> IForgeMenuType.create(MovingLimitedBarrelContainerMenu::fromBuffer));

	public static final RegistryObject<MenuType<MovingLimitedBarrelSettingsContainerMenu>> MOVING_LIMITED_BARREL_SETTINGS_CONTAINER_TYPE = MENU_TYPES
			.register("moving_limited_barrel_settings", () -> IForgeMenuType.create(MovingLimitedBarrelSettingsContainerMenu::fromBuffer));
