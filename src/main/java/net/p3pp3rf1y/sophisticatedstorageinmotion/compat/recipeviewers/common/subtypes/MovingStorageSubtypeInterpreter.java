...
public class MovingStorageSubtypeInterpreter extends PropertyBasedSubtypeInterpreter {
	public MovingStorageSubtypeInterpreter() {
		...
		addOptionalProperty(stack -> stack.getItem() instanceof StorageBoatItem ? Optional.of(StorageBoatItem.getBoatType(stack)) : Optional.empty(), "boatType", Boat.Type::name);
	}
}
